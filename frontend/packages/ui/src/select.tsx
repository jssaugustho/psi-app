...
export function Select({
  ...
  return (
    <div ref={containerRef} className="relative w-full text-left">
      ...
      {isOpen && (
        <div 
          className="absolute top-full left-0 right-0 mt-1.5 z-[999] glass-lg rounded-xl border border-[var(--surface-border)] shadow-2xl py-1 overflow-y-auto max-h-60 custom-scrollbar"
        >
