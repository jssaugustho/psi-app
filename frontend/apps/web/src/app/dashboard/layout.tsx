...
function getFriendlyPath(path: string): string {
  ...
  if (path.startsWith('/dashboard/captacao')) return 'Editando Páginas';
...
function DashboardContent({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { label: 'Captação', href: '/dashboard/captacao', icon: <GlobeIcon />, active: pathname.startsWith('/dashboard/captacao') },
