...
| Site Editor / Visual Builder (Elementor Flex-box) | [.agents/architectures/site_editor.md](file:///c:/Users/josea/Documents/Desenvolvimento/psi-app/.agents/architectures/site_editor.md) | Canvas v2.0, Section & Div containers, Atomic components, PropertiesPanel, Mobile Overrides, usePageEditor hook |
...
| Criação de Templates de Páginas (CanvasData v2.0) | [.agents/architectures/page_templates.md](file:///c:/Users/josea/Documents/Desenvolvimento/psi-app/.agents/architectures/page_templates.md) | Construtores (`createDefaultSection/Div/Component`), schema CanvasData v2.0, CSS vars, anti-patterns de cor, paridade canvas/painel |
| Monorepo Canvas Renderer Package (@psi/canvas-renderer) | [.agents/architectures/canvas_renderer_package.md](file:///c:/Users/josea/Documents/Desenvolvimento/psi-app/.agents/architectures/canvas_renderer_package.md) | Pacote compartilhado `@psi/canvas-renderer`, paridade 100% editor vs site publicado, flag `isPublicView`, wrappers universais |
