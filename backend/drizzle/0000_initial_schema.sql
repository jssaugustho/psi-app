...
CREATE TABLE IF NOT EXISTS "platform_settings" (
	...
	"card_light_color" text DEFAULT '#FFFFFF' NOT NULL,
	"card_dark_color" text DEFAULT '#18181B' NOT NULL,
	"text_light_color" text DEFAULT '#0F172A' NOT NULL,
	"text_dark_color" text DEFAULT '#F8FAFC' NOT NULL,
